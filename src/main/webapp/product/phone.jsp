            ...
            <c:forEach items="${products}" var="product">
                <div class="item">
                    <div class="thumbnail container" >
                        <div class="row">
                           <div class="col-xs-3"> <img style=" margin-left: 15px" src="${product.imageUrl}" alt="" class="img-responsive" style="max-width: 300px; max-height: 300px;">
                               <p style="margin-left: 100px;margin-top: 10px"> ${product.price} BYN</p>
                               <a type="button" style="margin-left: 66px" href="<c:url value='/product/order/phone/${product.id}'/>" class="btn basket_btn">Добавить в корзину </a>
